					    ...
					    if(mysqli_num_rows($quer1)>0){
						    while($row = mysqli_fetch_array($quer1)){
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td><button class='print-btn'><a href='stu_receipt.php?aadhar=$row[aadhar]&date=$row[date_of_visit]&scode=$row[scode]'>Print</a></button></td>";
                                    echo "<td><button class='stu-update-btn'><a href='update_student.php?aadhar=$row[aadhar]&date=$row[date_of_visit]'>Update</a></button></td>";
                                    echo "<td><button class='stu-delete-btn'><a href='confirmation_delete_student.php?aadhar=$row[aadhar]&date=$row[date_of_visit]'>Delete</a></button></td>";
                                echo "</tr>";
				            }
			            }else{
				            echo "0 results";
