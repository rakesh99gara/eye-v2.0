  ...
  <body>
    <script>
      $(document).ready(function() {
        ...
        var scode = "<?php echo $sch_code; ?>";
        var date = "<?php echo $date_of_visit; ?>";
        mydata = "sch_code=" + scode + "&date_of_visit=" + date;
        $.ajax({
                type: "POST",
                url: "set_update_school_values.php",
                data: mydata,
                dataType: "json",
                success: function(x) {
                    function insert(s) {
    ...
    <main>
      <section>
        <div class="main-details">
          <div class="heading">
            <h4>Update School Details</h4>
          </div>
          <div class="school-form">
            <form action="update_school_details.php" method="post" id="form">
              ...
              <input type="date" name="date" id="date" placeholder="Date" value="<?php echo $date_of_visit?>" readonly/>
